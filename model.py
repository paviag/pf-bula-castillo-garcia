...
model.train(data="pf-bula-castillo-garcia\data.yaml", epochs=50, imgsz=288, device="cpu", workers= 16) #no se si ese imgsz afecte el resultado por el resize automatico que hace
